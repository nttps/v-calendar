import { DayOfWeek, OrdinalWeekInMonth, DayParts } from './helpers';
...
export declare type RuleType = GroupRuleType | IntervalRuleType | ComponentRuleType | OrdinalComponentRuleType | FunctionRuleType;
export declare type OrdinalArrayConfig = SingleOrArray<[
    OrdinalWeekInMonth,
    ...DayOfWeek[]
]>;
