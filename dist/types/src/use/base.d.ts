...
import { DayOfWeek } from '../utils/date/helpers';
...
export declare type BaseProps = Readonly<ExtractPropTypes<typeof propsDef>>;
export declare type BaseContext = ReturnType<typeof createBase>;
