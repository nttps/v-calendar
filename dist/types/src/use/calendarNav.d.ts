...
export declare type IQuerySelector = Pick<HTMLElement, 'querySelector'>;
export declare type CalendarNavContext = ReturnType<typeof createCalendarNav>;
export declare type CalendarNavProps = Readonly<ExtractPropTypes<typeof propsDef>>;
...
export declare function createCalendarNav(props: CalendarNavProps, { emit }: any): {
    ...
    monthMode: import("vue").Ref<boolean, boolean>;
