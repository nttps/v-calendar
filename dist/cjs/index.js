...
function useBase() {
  const context = vue.inject(contextKey$3);
  if (context)
    return context;
  throw new Error(
...
function createCalendar(props, { emit, slots }) {
  ...
  const firstPage = vue.computed(() => head$1(state2.pages) ?? null);
  const lastPage = vue.computed(() => last$1(state2.pages) ?? null);
  ...
  const isMonthly = vue.computed(() => state2.view === "monthly");
  const isWeekly = vue.computed(() => state2.view === "weekly");
  const isDaily = vue.computed(() => state2.view === "daily");
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        show.value.title ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", _hoisted_1$8, [
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.renderSlot(_ctx.$slots, "day-content", {
      day: _ctx.day,
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createElementVNode("div", {
      ...
      vue.createElementVNode("div", _hoisted_1$6, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.page.weekdayLabels, (wl, i) => {
          return vue.openBlock(), vue.createElementBlock("div", {
            key: i,
            class: "vc-weekday"
          }, vue.toDisplayString(wl), 1);
        }), 128))
      ]),
...
function createDatePicker(props, ctx) {
  ...
  function forceUpdateValue(value, {
    ...
    if (fInput)
      formatInput();
    if (mValue) {
      vue.nextTick(() => moveToValue(targetPriority));
    }
...
function createTimePicker(props) {
  ...
  const showBorder = vue.computed(() => !isTimeMode.value);
...
const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(["vc-time-picker", [{ "vc-invalid": !vue.unref(isValid), "vc-bordered": vue.unref(showBorder) }]])
      }, [
